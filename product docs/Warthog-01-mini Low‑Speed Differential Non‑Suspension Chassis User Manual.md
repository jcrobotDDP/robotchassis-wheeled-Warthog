# <span style="color: #FF6B6B">Warthog-01-mini Low‑Speed Differential Non‑Suspension Chassis User Manual</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/83cef8b2-4102-449b-97e5-2aa215530d0b" />
...
| :--- | :---: | :--- | :---: |
| Dimensions reference | 430 × 434 × 175 mm | Platform size | 325 × 256 mm |
| Chassis weight (unloaded) | ≤ 12 kg | Operating speed | 3.4 km/h |
| Main material | Aluminium alloy | Surface finish | Matte black |
| Ground clearance | 50 mm | Protection rating | IP54 |
| Steering method | Pivot turn capable | Maximum payload | ≤ 18 kg |
| Wheelbase | 255 mm | Max gap crossing | ≥ 30 mm |
| Max vertical obstacle clearance | ≥ 80 mm | Max climbing angle | ≥ 20° |
| Tyre diameter | 175 mm | Motor | 250 W brushless DC |
| Rated torque | 3 N·m | No‑load speed | 482 RPM |

**Medium‑speed version:** *(Not available for this model)*

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Dimensions reference | 430 × 434 × 175 mm | Platform size | 325 × 256 mm |
| Chassis weight (unloaded) | ≤ 12 kg | Operating speed | 8.9 km/h |
| Main material | Aluminium alloy | Surface finish | Matte black |
| Ground clearance | 50 mm | Protection rating | IP54 |
| Steering method | Pivot turn capable | Maximum payload | ≥ 5 kg |
| Wheelbase | 255 mm | Max gap crossing | ≥ 30 mm |
| Max vertical obstacle clearance | ≥ 80 mm | Max climbing angle | ≥ 20° |
| Tyre diameter | 175 mm | Motor | 250 W brushless DC |
| Rated torque | 1.13 N·m | No‑load speed | 1267 RPM |
...
| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Supply voltage | 24 V | Motor type | Brushless DC geared motor |
| Max total power | 500 W | Standby power consumption | Not specified |
| Chassis total weight | 12 kg | Chassis total current | 16 A |

---

### 6.5 Electrical Schematic

<img width="1191" height="843" alt="image" src="https://github.com/user-attachments/assets/fe9473e3-48f6-4e22-acab-fc08fa95c6f0" />

a) **Battery**: Standard 24V 10Ah lithium battery, maximum voltage 25.2V, cut‑off discharge voltage 20V.  
...
d) If the receiver is used to drive high‑power loads, it may cause loss of control – in such cases, use an external 5V power supply.

---

### 6.6 Development Documentation

[RoboMaster C620 Brushless Motor Speed Controller User Manual (Chinese/English/Japanese) V1.01.pdf](https://www.yuque.com/attachments/yuque/0/2024/pdf/2802136/1730443710643-a7cb9653-f9e0-46db-b0fb-3678c6053e10.pdf)
...
This chassis uses Channels 2 and 4 to independently control straight motion and steering. The right joystick controls chassis movement in 8 directions, all proportionally controlled – joystick deflection angle determines speed.
