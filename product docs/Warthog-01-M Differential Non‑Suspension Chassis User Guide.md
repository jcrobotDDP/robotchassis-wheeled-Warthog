# <span style="color: #FF6B6B">Warthog-01-M Differential Non‑Suspension Chassis User Guide</span>

<img width="640" height="360" alt="image" src="https://github.com/user-attachments/assets/4c036669-1ce4-4e88-961d-2dbb9875e997" />
...
The WARTHOG-01M is a highly integrated general‑purpose wheeled robot chassis. The entire vehicle integrates the battery and BMS system, power modules (providing 24V, 12V, and 5V outputs), brushless DC motors, high‑precision encoders and drivers, and braking components into the chassis powertrain assembly. The compact layout provides users with ample development space and creative possibilities, helping you build distinctive robot products.

---

### 6.2 Technical Dimensions (Diagram)

<img width="1920" height="1338" alt="image" src="https://github.com/user-attachments/assets/be6a969f-aeed-48f1-848f-712ebc4aafc6" />
...
**3.1 High‑Speed Version**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Dimensions reference | 908 × 708 × 310 mm | Platform size | 695 × 384 mm |
| Chassis weight (unloaded) | 60 kg | Operating speed | 16 km/h |
| Main material | Alloy steel plate / aluminium alloy | Surface finish | Yellow powder coating |
| Ground clearance | 98 mm | Protection rating | IP64 |
| Steering method | Differential steering | Maximum payload | 50 kg |
| Wheelbase | 595 mm | Max gap crossing | 250 mm |
| Max obstacle clearance | 150 mm | Max climbing angle | 30° |
| Tyre diameter | 310 mm | Motor | 48 V brushless DC motor |
| Rated torque | 40 N·m | Gear ratio | 10 |

**3.2 Low‑Speed Version**

| Parameter | Value | Parameter | Value |
| :--- | :---: | :--- | :---: |
| Dimensions reference | 908 × 720 × 350 mm | Platform size | 795 × 432 mm |
| Chassis weight (unloaded) | 75 kg | Operating speed | 5.8 km/h |
| Main material | Alloy steel plate / aluminium alloy | Surface finish | Yellow powder coating |
| Ground clearance | 80 mm | Protection rating | IP64 |
| Steering method | Differential steering | Maximum payload | 100 kg |
| Wheelbase | 595 mm | Max gap crossing | 250 mm |
| Max obstacle clearance | 100 mm | Max climbing angle | 30° |
| Tyre diameter | 310 mm (tyre width 122 mm) | Motor | 48 V brushless DC motor, 785 W × 2 |
| Rated torque | 127.445 N·m | Gear ratio | 30 |
...
| Max total power | 785 W × 2 | Standby power consumption | ≤ 50 W |
| Brake type (optional) | Power‑off braking type | Brake voltage | DC 48 V |
| Encoder (optional) | 1024 lines | Driver model | JCDBL6050‑2E |
| Chassis total weight | 56 kg | Chassis total current | 11 A |

---

### 6.5 Electrical Schematic

<img width="1021" height="657" alt="image" src="https://github.com/user-attachments/assets/3c45c32c-a6fe-48aa-af75-db8fc56238cd" />
...
**1) Packaging dimensions:** Minimum carton approx. 1100 × 800 × 500 mm.

**2) Handling requirements:**

a. The chassis is packed in a wooden crate with a wooden pallet base; total mass 80 kg. Use a pallet jack or forklift to move the pallet. When moving, do not tilt the crate more than 15 degrees. Ensure the fork fully supports the pallet to prevent tipping due to uneven centre of gravity. **Do not lift by the top cover or side panels** – the pallet may detach and damage the chassis.
...
<img width="1852" height="1102" alt="image" src="https://github.com/user-attachments/assets/16b6c6aa-6fab-4072-9609-5f682191a119" />

*Please open this page in a browser and download:*

[WTH-01M_Customer_Communication.rar](https://www.yuque.com/attachments/yuque/0/2023/rar/2802136/1687579754744-ab83218e-cfad-4969-b978-5b6c1e01b29c.rar)
</details>
...
> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/ogw7k3gze6z4qd12](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/ogw7k3gze6z4qd12)

> Yuque content card – click to view: [https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/zv9hsy3wmsvwrr79](https://www.yuque.com/jichuangjiqirenjcrobot/qokzma/zv9hsy3wmsvwrr79)
